...
<body>
    ...
    <form action="./2_member_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>
        아이디 : <input type="text" name="userid" id="userid" maxlength="20"> <input type="button" id="btnIdCheck" value="아이디 중복체크" >
         </p><p id="idcheckmsg"></p>
        ...
        <p> 
            주민번호 :  <input type="text" name="ssn1" id="ssn1" maxlength="6" onkeyup="moveFocus()" onkeydown="ssnChange()">- 
        <input type="text" name="ssn2" id="ssn2" maxlength="7"  onkeydown="ssnChange()"> <input type="button"
        value="주민등록번호 검증" onclick="ssnCheck()"></p>
        <p>
            우편번호 :  <input type="text" name="zipcode" id="sample6_postcode"> <input type="button"
            value="우편번호 검색"  onclick="sample6_execDaumPostcode()"></p>
            ...
            <input type="button" value="로그인" onclick="location.href='./2_login.jsp'"></p>
